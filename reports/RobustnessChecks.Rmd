...
```{r, C-DBR_00_Pipeline_Graph_dark-blue, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
ggraph(g,
       'sugiyama') + 
    geom_edge_diagonal(colour = "steelblue2")+
...
ggraph(g,
       'sugiyama') + 
    geom_edge_diagonal(colour = "green")+
    geom_node_point(size = 2,
                    color = "white")+
    geom_node_text(aes(label = name),
                   color = "white",
