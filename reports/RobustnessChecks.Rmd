...
```{r, C-DBR_00_Pipeline_Graph_orange, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
ggraph(g,
       'sugiyama') + 
    geom_edge_diagonal(colour = "orange")+
