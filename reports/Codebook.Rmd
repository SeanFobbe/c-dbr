...
```{r C-DBR_03_Einzelnormen_Barplot_Ausfertigungsjahr, fig.height = 7, fig.width = 11}
...
```{r C-DBR_03_Rechtsakte_Barplot_Ausfertigungsjahr, fig.height = 7, fig.width = 11}
...
```{r C-DBR_03_Meta_Barplot_Ausfertigungsjahr, fig.height = 7, fig.width = 11}
